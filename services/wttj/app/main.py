...
# Fix for Python 3.14+ on Windows - Playwright subprocess issue
if sys.platform == 'win32' and sys.version_info >= (3, 14):
    try:
        asyncio.set_event_loop_policy(asyncio.WindowsProactorEventLoopPolicy())
        logging.info("✓ Windows ProactorEventLoop policy set for Python 3.14+")
...
async def _onboard_background(
    ...
    db2 = _SL()
    try:
        auto_result = await _run_firefox_signup_and_onboard(
            email=wttj_email,
